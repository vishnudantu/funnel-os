...
export default function LoginPage() {
    ...
    return (_jsx("div", { className: "min-h-screen flex items-center justify-center bg-[#F8FAFC] px-4", children: _jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, className: "w-full max-w-md", children: [_jsxs("div", { className: "text-center mb-8", children: [_jsx("h1", { className: "text-3xl font-bold text-[#0F172A]", children: "Saleduct" }), _jsx("p", { className: "text-slate-600 mt-2", children: "AI-Native Sales Platform" })] }), _jsxs("div", { className: "bg-white rounded-2xl shadow-sm border border-[#E2E8F0] p-8", children: [_jsxs("div", { className: "flex mb-6", children: [_jsx("button", { onClick: () => setMode('login'), className: cn('flex-1 py-2 text-sm font-medium border-b-2 transition-colors', mode === 'login'
